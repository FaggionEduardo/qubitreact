...
const UpcomingsEdit = gql`
  mutation UpcomingsEdit($id:ID!, $text:String!, $link:String!,$year:String!, $location:String!){
    updateUpcoming(
      id:$id
      year:$year
      location:$location
...
const UpcomingsCreate = gql`
  mutation UpcomingsCreate( $text:String!, $link:String!, $year:String!, $location:String!){
    createUpcoming(
      year:$year
      location:$location
      text:$text
